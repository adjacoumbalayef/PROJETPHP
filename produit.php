...
try {
    $sql = "SELECT * FROM produits $whereClause ORDER BY date_ajout DESC";
                                ...
                                <tbody>
                                    <?php foreach ($produits as $produit): ?>
                                        <tr>
                                            ...
                                            <td><strong class="text-success"><?php echo number_format($produit['prix'], 2, ',', ' '); ?> €</strong></td>
                                            <td>
                                            ...
                                            <td><?php echo date('d/m/Y H:i', strtotime($produit['date_ajout'])); ?></td>
                                            <td>
